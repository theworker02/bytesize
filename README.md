...
[![npm](https://img.shields.io/npm/v/%40magnexis/bytesize.svg)](https://www.npmjs.com/package/%40magnexis/bytesize)

Package version **1.00** (`1.0.0`). Default branch is **`main`** — never `master`.

**Docs:** [GitHub Pages](https://theworker02.github.io/bytesize/) · **Source:** [`theworker02/bytesize`](https://github.com/theworker02/bytesize) · **Release 1.00:** [`v1.0.0`](https://github.com/theworker02/bytesize/releases/tag/v1.0.0) · **npm:** [`@magnexis/bytesize`](https://www.npmjs.com/package/%40magnexis/bytesize)
...
```bash
npm i -g @magnexis/bytesize
bytesize --help
```

Package page: https://www.npmjs.com/package/%40magnexis/bytesize
...
```bash
npx --yes @magnexis/bytesize --help
